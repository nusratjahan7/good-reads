                    ...
                    <div className="bg-white backdrop-blur-2xl shadow-xl !px-8 !py-9 rounded-2xl ">
                        ...
                        <div>
                            <div className="flex flex-col items-center gap-1 !pb-4">
                                <h1 className="text-3xl font-bold text-(--rust) font1">Login your account</h1>
                            </div>
                        ...
                        <Form className="flex sm:w-96 flex-col gap-4" onSubmit={onSubmit}>
                            ...
                            <div className="flex flex-col items-center gap-2">
                                ...
                                {/* Google */}
                                <button className="btn bg-white text-black border-[#e5e5e5] !px-3 w-full roboto font-bold">
