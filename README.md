...
- 📚 **Book Exploration**: Users can search and filter books, view details, and access popular and best-selling books.
- 🔒 **Private Routes**: The book details page and user profile page are protected by private routes (authentication required).
- ✨ **Framer Motion Animations**: Smooth, interactive transitions for an engaging user experience.
- 📊 **Marquee**: Used for displaying dynamic statistics or updates on the homepage (e.g., new arrivals or promotions).
...
- **Tailwind CSS**: Utility-first CSS framework for responsive, customizable layouts.
- **Framer Motion**: Animation library to create smooth transitions and interactive animations.
...
2. **Push to the branch:**: 
   ...
   ```
5. Open a pull request with detailed information

## Acknowledgements

- **[Tailwind CSS](https://tailwindcss.com/)** for the utility-first CSS framework.
- **[Framer Motion](https://www.framer.com/motion/)** for animations.
- **[Swiper.js](https://swiperjs.com/)** for creating carousels.
- **[Toastify](https://fkhadra.github.io/react-toastify/)** for the toast notifications.
- **[BetterAuth](https://www.npmjs.com/package/better-auth)** for handling authentication.


### Key Sections:
- **Purpose**: Provides an overview of the project.
- **Live URL**: Direct link to the deployed app.
- **Key Features**: Highlights the key features of the application.
- **Technologies Used**: Lists the technologies and libraries utilized in the project.
- **NPM Packages Used**: Lists all npm packages used in the project.
- **Installation**: Provides clear, step-by-step instructions on setting up the project locally.
